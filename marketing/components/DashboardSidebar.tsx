...
export function DashboardSidebar() {
  ...
  const navItems = [
    ...
    { label: "Opportunités SEO", icon: Lightbulb, href: `${base}/opportunites` },
    { label: "Articles", icon: FileText, href: `${base}/articles` },
    { label: "Générer un article", icon: PenLine, href: `${base}/generer` },
    ...
    { label: "Images", icon: Image, href: `${base}/images` },
    { label: "Paramètres", icon: Settings, href: `${base}/parametres` },
  ];

  const insightsItems = [
    {
      label: "Analyseur SERP",
      icon: Search,
