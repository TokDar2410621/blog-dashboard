    ...
    <Card>
      <CardHeader>
        ...
        <p className="text-sm text-muted-foreground">
          Récupère les questions Google PAA pour ton mot-clé, génère des réponses courtes, et produit un schema FAQPage prêt à coller.
        </p>
      </CardHeader>
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <Input
              ...
              placeholder="Ex: tva auto-entrepreneur québec"
              onKeyDown={(e) => {
          ...
          <div className="space-y-4">
            {data.questions.length === 0 ? (
              <p className="text-sm text-muted-foreground text-center py-4">
                Aucune question PAA trouvée pour ce mot-clé.
              </p>
            ) : (
              <>
                <div className="space-y-2">
