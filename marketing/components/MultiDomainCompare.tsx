...
export function MultiDomainCompare() {
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Vue d&apos;ensemble de tous tes sites en une page. Identifie quels sites ont besoin d&apos;attention.
            </p>
          </div>
        </div>
        ...
        {data && (
          <>
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <div className="text-xs text-muted-foreground mt-1">
                    Sites actifs sur {data.totals.sites_count}
                  </div>
                </CardContent>
              </Card>
              <Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Par site</CardTitle>
              </CardHeader>
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="text-center">GSC</TableHead>
                      <TableHead className="text-center">EEAT</TableHead>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground mt-2">
                    Connecte tes sites manquants pour suivre leurs performances Google.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground mt-2">
                    Remplis les champs Profil auteur sur chaque site pour booster les signaux E-E-A-T.
                  </p>
                </CardContent>
              </Card>
            </div>
