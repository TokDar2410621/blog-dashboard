...
from .views import (
    ...
    UploadImageView, ServeImageView, SiteImagesView, SiteImageUploadView,
    SEOAuditView, SEOFixView, SEOSuggestView,
...
urlpatterns = [
    ...
    path('sites/<int:site_id>/images/', SiteImagesView.as_view(), name='site-images'),
    path('sites/<int:site_id>/images/upload/', SiteImageUploadView.as_view(), name='site-images-upload'),
    ...
    path('v1/sites/<int:site_id>/clusters/build/',
         V1ClusterBuildView.as_view(), name='v1-clusters-build'),
    path('v1/sites/<int:site_id>/index-coverage/',
         V1IndexCoverageView.as_view(), name='v1-index-coverage'),
    path('v1/sites/<int:site_id>/indexnow/',
