/**
 * Public audit page - the lead magnet front-end. No auth required.
 *
 * Route: /audit
 *
 * Flow:
 *   1. Visitor types domain -> POST /api/public/audit/ -> partial result
 *   2. We render score + top keywords + PageSpeed + 2 recos.
 *   3. To unlock the full report (competitors + decay + all recos),
 *      visitor leaves email -> POST /api/public/leads/ -> we reveal it.
 *
