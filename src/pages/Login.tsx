...
import { login, checkEmail, register, requestPasswordReset } from "@/lib/api-client";
...
export default function Login() {
  ...
  const heading =
    step === "email"
      ...
      : step === "oauth-only"
      ? t("login.continueWithProvider", "Continue avec ton compte")
          ...
          {step === "oauth-only" && (
            <div className="space-y-4">
              <p className="text-sm text-muted-foreground">
                {t(
                  "login.oauthOnlyHint",
                  "Ton compte a été créé via un fournisseur externe. Connecte-toi avec le même service :",
                )}
              </p>
              <div className="space-y-2">
