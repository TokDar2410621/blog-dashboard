/**
 * Politique de confidentialité Gridar.
 *
 * IMPORTANT: ceci est un point de départ rédigé pour matcher l'opération
 * réelle de Gridar (sous-traitants Anthropic, Stripe, Google, Serper, Vercel,
 * Railway). Faire réviser par un avocat québécois familier avec la Loi 25
    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-30 border-b border-border/50 bg-background/95 backdrop-blur">
        <div className="max-w-4xl mx-auto px-4 md:px-6 h-14 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-muted-foreground hidden sm:inline">/ Confidentialité</span>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-3xl mx-auto px-4 md:px-6 py-10">
        ...
        >
          ...
          <hr />
          <p className="text-sm text-muted-foreground">
            Voir aussi : <Link to="/terms">Conditions d'utilisation</Link>.
          </p>
        </article>
      </main>
    </div>
